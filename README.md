...
## 1   Rate        2 0.0707 1.87 2.14
## 
## Distribution Properties:
##     Aspect Estimate     SE     L     U
## 1     Mean    0.499 0.0176 0.464 0.533
## 2   Median    0.346 0.0122 0.322 0.370
## 3 Variance    0.249 0.0176 0.215 0.283
```
...
## Estimated Parameters:
##   Aspect Estimate     SE    L    U
## a  Shape     2.03 0.0931 1.86 2.22
## l   Rate     2.00 0.1110 1.79 2.23
## 
## Distribution Properties:
##     Aspect Estimate     SE     L     U
## 1     Mean    1.020 0.0259 0.965 1.070
## 2   Median    0.855 0.0218 0.812 0.897
## 3 Variance    0.508 0.0373 0.434 0.581
## 
## Restricted Mean Survival Times:
##   Tau Estimate      SE     L     U
## 1 0.5     0.45 0.00322 0.444 0.457
```
